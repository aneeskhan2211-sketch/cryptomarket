import { c as createLucideIcon, r as reactExports, u as useCoinChart } from "./index-CAwuyKvd.js";
/**
...
function usePortfolioChart({
  ...
  const merged = reactExports.useMemo(() => {
    var _a;
    if (!enabled) return { points: [], loadedCount: 0 };
    const pairs = [
      [top[0] ?? null, data0],
      [top[1] ?? null, data1],
      [top[2] ?? null, data2],
